    ...
    return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { onClick: () => setShowHelp(!showHelp), className: "p-2 rounded-full hover:bg-gray-100 transition-colors" },
                            React.createElement(HelpCircle, { className: "h-6 w-6 text-gray-600" })
                        ),
                        React.createElement(
                            'button',
                            { onClick: () => setCurrentStep(1), className: "p-2 rounded-full hover:bg-gray-100 transition-colors" },
        ...
        React.createElement(
            ...
            showHelp && React.createElement(
                'div',
                { className: "mb-8 bg-white rounded-lg shadow-md p-6 border-yellow-500" },
                React.createElement(
                    'h3',
                ...
                React.createElement(
                    ...
                    "Cette application vous guide à travers les concepts fondamentaux du stockage numérique. Suivez chaque étape et complétez les exercices pour progresser. Vous pouvez toujours revenir en arrière ou recommencer."
                )
            ),
            React.createElement(
                'div',
                { className: "bg-white rounded-lg shadow-xl p-6 border-gray-200" },
                renderCurrentStep()
            )
        )
    );
